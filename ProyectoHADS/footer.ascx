    ...
    <ContentTemplate>
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                ...
                <asp:Label ID="lblUsuario" runat="server" ForeColor="Blue" style="font-weight: 700"></asp:Label>
                <br />
                Los usuarios conectados son
                <asp:Label ID="lbCount" runat="server" ForeColor="#009933" style="font-weight: 700"></asp:Label>
                <br />
                    <br />
                    <br />
                    <br />
