...
&nbsp;
    ...
    <h3 class="auto-style1">&nbsp;<asp:LinkButton ID="lbXSLT" runat="server" style="font-weight: 700">VER XSLT</asp:LinkButton>
    &nbsp;<asp:Image ID="Image4" runat="server" Height="24px" ImageUrl="~/iconos/two-rows-and-three-columns-layout.png" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;
        <asp:LinkButton ID="lbAlum" runat="server" style="font-weight: 700; font-size: large">Ir a seccion alumnos</asp:LinkButton>
    &nbsp;<asp:Image ID="Image5" runat="server" Height="24px" ImageUrl="~/iconos/man-walking-directions-button.png" />
&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:LinkButton ID="lbCoordinador" runat="server">Coordinador</asp:LinkButton>
&nbsp;<asp:Image ID="imgCoordinador" runat="server" Height="24px" ImageUrl="~/iconos/set-timer-button.png" Width="24px" />
    </h3>
